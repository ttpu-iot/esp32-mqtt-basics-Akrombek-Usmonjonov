...
const char* client_id = "akrombek_lab3";

// Topics
const char* topic_button  = "ttpu/iot/akrombek/events/button";
const char* topic_red     = "ttpu/iot/akrombek/led/red";
const char* topic_green   = "ttpu/iot/akrombek/led/green";
const char* topic_blue    = "ttpu/iot/akrombek/led/blue";
const char* topic_yellow  = "ttpu/iot/akrombek/led/yellow";
const char* topic_display = "ttpu/iot/akrombek/display";
